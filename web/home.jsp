...
<%
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
            ...
            <div id="bdy" style="color: #ffffff">
                ...
                <div class="row">
                    <div class="col-sm-12">
<h1 style="font-family: sans-serif;  font-size: 4vw; color: #CCCCCC; text-shadow: 2px 2px 3px black" class="text-uppercase text-center"><b>${company}</b></h1>
                    </div>
                </div>
                <div class="row">
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                            ...
                            <div class="col-sm-4 col-md-4">
                                <button style=" border-bottom-left-radius: 50px; border-top-right-radius: 50px" class="btn btn-success btn-block"><h3><strong> Stock Info<br> ${stocktotal}|${stockqty}<br>${astocktotal}|${astockqty} </strong></h3></button>
                            </div>
                            <div class="col-sm-4 col-md-4">
                                <button style=" border-bottom-left-radius: 50px; border-top-right-radius: 50px" class="btn btn-success btn-block"><h3><strong> Sale Info<br> ${saletotal}|${tqty}<br> ${asaletotal}|${atqty}</strong></h3></button>
                            </div>
                           <%                                
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                ...
                                %>
                                <button style=" border-bottom-left-radius: 50px; border-top-right-radius: 50px" class="btn btn-success btn-block"><h3><strong>Balance <br>Cash | Bank <br> ${nbalance} |${deposittotal-withtotal}</strong></h3></button> 
