                                            ...
                                            <tbody id="myTable">
                                                <%
                                                    ...
                                                    try {
                                                        ...
                                                        String query = "select PRODUCT_ID, CUSTOMER_ID, INVOICE_NO,BRAND, MODEL, COLOR, PRICE, DISCOUNT, DIS_NOTE, VENDOR, SELL_DATE from mobilesell where SELL_DATE= '"+ date1 +"' order by SELL_DATE ";
                                        ...
                                        <table border="2" class="table-striped table-responsive" width="100%" id="actable" >
                                            ...
                                            <tbody>
                                                <%
                                                    ...
                                                    try {
                                                        con = Ssymphonyy.getConnection();
                                                        String query = "select PRODUCT_NAME, PRODUCT_ID, MODEL, SELL_PRICE, DISCOUNT, DIS_NOTE, VENDOR, INVOICE_NO, CUSTOMER_ID, DATE from accessor_sale where DATE= '"+ date1 +"' order by DATE ";
                                                        ps=con.prepareStatement(query);
                                                        rs = ps.executeQuery();
                                                        while (rs.next()) {
                                                   int cid=rs.getInt(9);
