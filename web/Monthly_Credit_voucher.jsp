                            ...
                            <li style="margin: 15px 15px">
                                <div>
                                    <form action="Datewise_Credit_voucher.jsp" method="POST" class="form-inline">
                                        ...
                                        <label style="color: white">TO</label> <input type="date" autocomplete="off" size="10px" class="form-control"  name="date2" value="" required="" placeholder="End Date" >
                            ...
                            <div id="div_print">
                                <center>
                                   ...
                                   <center><h4><div id="date"> </div> </h4></center>
                                    <hr>
                                    <table border="2" class="table table-condensed table-responsive" width="90%" id="mobiletable" >
                                        <thead>
