            ...
            <center>
                <div class="panel panel-primary" style="width: 100%; background-color: #CDCBCB">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-sm-12">
                            <form method="POST" action="Product_UpdateServlet">
                                ...
                                <table border="1px" width="70%" class="table-responsive table-condensed">
                                    <%
                                        ...
                                        try {
                                            ...
                                            String query = "select * from stock where IMEI=? ";
                                    ...
                                    <input type="hidden" name="sino1" value="<%= rs.getInt("SI_NO") %>" >
                                      <input type="hidden" name="sino2" value="${vimei}" >
                                        <td><input type="text" class="form-control" name="brand" value="<%= rs.getString("BRAND")%>" required="" ></td>
                                    </tr>
                                    <tr>
                                        <td>Model :</td>
                                    ...
                                    <tr>
                                        <td>Imei :</td>
                                        <td><input type="text" class="form-control" name="imei" value="<%= rs.getString("IMEI")%> " required="" ></td>
                                    </tr>
                                    <tr>
                                        <td>Purchase Price :</td>
                                        <td><input type="text" class="form-control" name="pprice" value="<%= rs.getString("PURCHASE_PRICE")%> " required="" ></td>
                                    </tr>
                                    \<tr>
                                        <td>Sell Price :</td>
