                ...
                <nav style="margin: 0 auto" class="navbar navbar-inverse ">
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a data-toggle="collapse" data-target="#sdateview" href="#" >Single Date View</a></li>
                             <li>
                                <div id="sdateview" class="collapse" style="margin:10px 0px">
                                    <form  method="POST" action="single_date_sale.jsp" class="form-inline">
                            ...
                            <li id="drop"><a href="#" >Date to Date View</a>
                            <div  id="dropdown" class=" dropdown-menu" >
                            ...
                            <li>
                                <div id="mdateview" class="collapse" style="margin:10px 0px">
                                    <form  method="POST" action="datewise_mobile_sale.jsp" class="form-inline">
                                        ...
                                        <label style="color: white">TO</label> <input type="date" autocomplete="off" class="form-control" size="10px" name="date2" value="" placeholder="End Date" required="" >
                                        <input type="submit" class="btn btn-primary btn-sm" value="View">
                                    </form>
                                </div>
                            </li>
