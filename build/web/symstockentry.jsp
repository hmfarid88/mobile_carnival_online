                                   ...
                                   <table class="table" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" maxlength="15" minlength="15" pattern="[0-9]{15}"  name="imei" id="imei" value="" autofocus="" class="form-control" required="" ></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                ...
                $(document).ready(function () {
                    $("#submit").click(function () {
                        ...
                        <div id="div_print" class="col-sm-6"><br><br>
                            <center><h4><strong>Today's Entry</strong></h4></center>
                            <div class="row">
                                <center>
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                            ...
                            <div  class="row">
                                ...
                                <center>
                                    ...
                                    <table border="2" id="mobiletable" class="table table-condensed table-responsive" width="100%" >
                                        <thead>
