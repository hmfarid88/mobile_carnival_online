...
<html class="no-js" lang="">
    ...
    <div id="main" class="container-fluid" style="background-color: #030303; ">
        <nav style="margin: 0 auto; border-color: green" class="navbar navbar-inverse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li>
                     ...
                     <form method="POST" action="Net_balance_list.jsp" class="form-inline" >
                        ...
                        <label style="color: white">TO</label> <input type="date" autocomplete="off" size="10px" class="form-control" name="date2" value="" placeholder="End Date" required="" >
                    ...
                    <form id="retpay" method="POST" action="RetailerpayServlet">
                        ...
                        <select   name="rtname" id="paymentname" class="form-control"  required="" >
                            ...
                            <%
                                ...
                                try {
                                    con = Ssymphonyy.getConnection();
                                    String query = "select distinct RETAILER from vendor_sale where RETAILER is not null";
                                    ps = con.prepareStatement(query);
                                    rs = ps.executeQuery();
                                    while (rs.next()) {
                            %>
                            <option value="<%= rs.getString("RETAILER")%>"><%= rs.getString("RETAILER")%></option>
                            <%
                                    }
                                } catch (Exception ex) {
                                }finally {
  ...
  try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
       ...
       <div class="col-sm-10">
            ...
            <div id="div_print" style="color: #ffffff; background-color: #030303">
                ...
                <center>
                    <table  border="2" width="90%" class="table table-condensed  table-responsive" >
                        <thead>
                            <tr>
