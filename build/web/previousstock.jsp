                        ...
                        <%
                           try {
                                ...
                                String query="select BRAND, MODEL, COLOR, IMEI, PURCHASE_PRICE, SELL_PRICE, VENDOR, DATE from stock where MODEL not like '%"+ demo +"%' and  DATE<='"+ date +"'"
                                        ...
                                        + "UNION ALL select BRAND, MODEL, COLOR, PRODUCT_ID, COST_PRICE, STOCK_RATE, VENDOR, STOCK_DATE from vendor_sale where MODEL not like '%"+ demo +"%' and STOCK_DATE<='"+ date +"' AND SELL_DATE>'"+ date +"'";
